...
export default function TodoPage() {
  ...
  const [unreadMentions, setUnreadMentions] = useState(new Set()); // Set of todo_ids
                  ...
                  <div key={c.id}>
                    ...
                    {replies.length > 0 && (
                      <div style={{ marginLeft: 56, marginBottom: replyingTo === c.id ? 8 : 20, display: "flex", flexDirection: "column", gap: 6 }}>
                        {replies.map(r => (
                          <div key={r.id} style={{ background: "#0d0f14", border: "1px solid #1e2130", borderRadius: 8, padding: "10px 12px", position: "relative" }}>
